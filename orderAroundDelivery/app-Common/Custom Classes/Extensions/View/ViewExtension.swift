...
//    }
    ...
    func addBlurview(with style : UIBlurEffect.Style = .dark, on completion : @escaping (()->Void), tapGesture : UIGestureRecognizer? = nil) {
       ...
       // blurEffectView.transform = CGAffineTransform(scaleX: 0.1, y: 0.1)
        ...
        if tapGesture != nil {
             blurEffectViewGlobal?.addGestureRecognizer(tapGesture!)
        }
    ...
    func drawDottedLine(start p0: CGPoint, end p1: CGPoint, view: UIView, lineColor color : UIColor = UIColor.lightGray) {
